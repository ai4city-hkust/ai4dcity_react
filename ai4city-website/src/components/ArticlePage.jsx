...
export const ArticlePage = ({ articleId, setPage, externalData = null }) => {
  // Use externalData if provided, otherwise look up by articleId, fallback to empty object
  const content = externalData || ARTICLE_CONTENT[articleId] || {};
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="w-full">
          {content.body && content.body.length > 0 ? (
            ...
            <p className="text-gray-300 italic py-20 text-center">Content coming soon...</p>
          )}
